...
import { ArrowLeft, Send, Image, MapPin, Phone } from 'lucide-react';
...
const Chat: React.FC = () => {
  ...
  const { orders, messages, addMessage, userType } = useOrder();
        ...
        {orderMessages.length === 0 ? (
          <div className="text-center py-12">
            <div className="bg-white rounded-lg p-6 shadow-sm max-w-sm mx-auto">
              ...
              <p className="text-gray-500 text-sm">تواصل مع الطرف الآخر لمناقشة تفاصيل الطلب</p>
            </div>
          </div>
        ) : (
