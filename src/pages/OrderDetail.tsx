  ...
  const handleApply = async () => {
    ...
    setTimeout(() => {
      ...
      setModal({
        ...
        message: 'تم تقديمك على الطلب بنجاح. سيتم إشعارك عند رد العميل.'
      });
    }, 1000);
  };
  ...
  const handleAcceptOrder = async () => {
    ...
    setTimeout(() => {
      ...
      setModal({
        ...
        type: 'success',
        title: 'تم قبول الطلب',
        message: 'تم قبول الطلب بنجاح. سيتم إشعارك عند موافقة العميل على بدء العمل.'
      });
    }, 1000);
  };
  ...
  const handleApproveWork = async () => {
    ...
    setTimeout(() => {
      ...
      setModal({
        isOpen: true,
        type: 'success',
        title: 'تم الموافقة على بدء العمل',
        message: 'تم الموافقة على بدء العمل. يمكنك الآن متابعة تقدم العمل مع الحرفي.'
      });
    }, 1000);
  };
